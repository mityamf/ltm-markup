...
var modalChoicesBtns = document.querySelectorAll('[data-modal="choices"]'); // аргументы setupModal(modal, closeCallback, modalBtns, openCallback, noPrevDefault, preventScrollLock)
  ...
  if (toggleBtn) {
    var changeBlock = function changeBlock() {
      ...
      if (breakpointWidth.matches) {
        ...
        toggleBtn.addEventListener('change', function (evt) {
