...
/* harmony import */ var _vendor_choices__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/choices */ "./js/vendor/choices.js");
...
choices_js__WEBPACK_IMPORTED_MODULE_0___default.a.prototype._onMouseDownOld = choices_js__WEBPACK_IMPORTED_MODULE_0___default.a.prototype._onMouseDown;

choices_js__WEBPACK_IMPORTED_MODULE_0___default.a.prototype._onMouseDown = function (evt) {
  var _this = this;
  ...
  if (evt.target.dataset.value && evt.target.dataset.value.toLowerCase() === 'SelectAll'.toLowerCase()) {
    if (this.getValue().length < this._store.choices.length - 1) {
      ...
      var _iterator = _createForOfIteratorHelper(this._store.choices),
          _step;
      ...
      elements.forEach(function (element) {
        return _this._addItem(element);
      });
    } else {
      this.removeActiveItems();

      var _iterator2 = _createForOfIteratorHelper(this._store.choices),
          _step2;

      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var _choice = _step2.value;
          _choice.choiceId = _choice.id;

          if (_choice.value.toLowerCase() === 'SelectAll'.toLowerCase()) {
            this._addItem(_choice);
          }
        }
      } catch (err) {
        _iterator2.e(err);
  ...
  choices_js__WEBPACK_IMPORTED_MODULE_0___default.a.prototype._onMouseDownOld.call(this, evt);
};

var setSelectAll = function setSelectAll(choices) {
  var _iterator3 = _createForOfIteratorHelper(choices._store.choices),
      _step3;
...
var choiceHandler = function choiceHandler(choiceElement) {
  choiceElement.containerInner.element.addEventListener('click', function (evt) {
  ...
  choiceElement.passedElement.element.addEventListener('choice', function (evt) {
    var selectedValues = choiceElement.getValue();
    var selectedValue = selectedValues.find(function (selectedValue) {
      return selectedValue.choiceId === evt.detail.choice.id;
    });

    if (selectedValue) {
      setTimeout(function () {
        return choiceElement.removeActiveItemsByValue(selectedValue.value);
      }, 10);
    }
  }, false);
};

var choices = Array.from(document.querySelectorAll('.input-dropdown')).map(function (item) {
  var choiceElement = new choices_js__WEBPACK_IMPORTED_MODULE_0___default.a(item, {
    searchEnabled: false,
    itemSelectText: '',
    removeItems: false,
